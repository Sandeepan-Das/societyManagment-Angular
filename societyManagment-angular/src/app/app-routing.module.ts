...
const routes: Routes = [
  { path: "houseDetails", component: HouseDetailsComponent, children: [{ path: "fetchResidents", component: FetchResidentComponent },{path:"search",component:SearchResidentComponent}] },
  {path:"signUp",component:CredentialsComponent},
  {path:"admin",component:AdminComponent,children:[{path:"insertHouse",component:InsertHouseComponent},{path: "insertResidents",component:InsertResidentsComponent},{path:"insertWorker",component:InsertWorkerComponent}]},
